...
//	static final String CONNECT_ADDR = "192.168.2.105:2181";
	/** session超时时间 */
...
//		System.out.println(cf.getState());
		...
		//creatingParentsIfNeeded表示递归创建，也就是如果父类需要创建，就创建
		cf.create().creatingParentsIfNeeded().withMode(CreateMode.PERSISTENT).forPath("/zookeeper/a","zx".getBytes());
		//5 删除节点
...
//		cf.create().creatingParentsIfNeeded().withMode(CreateMode.PERSISTENT).forPath("/super/c2","c2内容".getBytes());
		//读取节点
//		String ret1 = new String(cf.getData().forPath("/testRoot1"));
